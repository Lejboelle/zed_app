...
int main(int argc, char const **argv)
{
  ...
  static struct poptOption options[] = {
    ...
    { "init_inctr",'l',POPT_ARG_STRING,&init_intrinsic,0,"Initial intrinsic parameters","STR" },
  ...
  FileStorage fs1(init_intrinsic, FileStorage::READ);
  
  if (fs1.isOpened()) {
	cout << "loading init params.." << endl;
	fs1["K"] >> K;
	fs1["D"] >> D;
