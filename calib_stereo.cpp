...
int main(int argc, char const *argv[])
{
  ...
  double RMSError = stereoCalibrate(object_points, left_img_points, right_img_points, K1, D1, K2, D2, img1.size(), R, T, E, F, flag);
  ...
  stereoRectify(K1, D1, K2, D2, img1.size(), R, T, R1, R2, P1, P2, Q,  CV_CALIB_ZERO_DISPARITY, -1, Size (0,0), &validROI[0], &validROI[1]);
  cv::Rodrigues(R,Rv, noArray());
